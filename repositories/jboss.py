    ...
    for ext in extensions:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                log_warning(f"[JBoss Check] Unexpected status code {response.status_code} for URL: {artifact_url}")
